...
class Download(models.Model):
    ...
    project_name = models.CharField(max_length=500, blank=False, default=None, verbose_name=u'name of the project, initiative, study or application using MIGRATE data')
    project_description = models.CharField(max_length=1000, blank=False, default=None, verbose_name=u'brief description of this project, initiative, study or application')
